...
/**
 * @title CrosspolyV1Proxy03
 * @author Crosspoly Breeder
 *
 * @notice Entrance of trading in Crosspoly platform
 */
contract CrosspolyV1Proxy03 is ICrosspolyV1Proxy02, InitializableOwnable {
    ...
    uint256 public _GAS_Crosspoly_MAX_RETURN_ = 10;
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.timestamp, "CrosspolyV1Proxy03: EXPIRED");
        _;
    }
    ...
    function crosspolySwapV1(
        ...
        require(crosspolyPairs.length > 0, "CrosspolyV1Proxy03: PAIRS_EMPTY");
        require(minReturnAmount > 0, "CrosspolyV1Proxy03: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_SELL_CHI");
        require(toToken != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_BUY_CHI");
        ...
        if (fromToken != _ETH_ADDRESS_) {
            ...
            require(msg.value == fromTokenAmount, "CrosspolyV1Proxy03: ETH_AMOUNT_NOT_MATCH");
        ...
        for (uint256 i = 0; i < crosspolyPairs.length; i++) {
            ...
            if (directions & 1 == 0) {
                ...
                require(curDodoBase != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_CHI");
                ...
                require(curDodoQuote != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_CHI");
        ...
        require(returnAmount >= minReturnAmount, "CrosspolyV1Proxy03: Return amount is not enough");
    ...
    function externalSwap(
        ...
        require(isWhiteListed[swapTarget], "CrosspolyV1Proxy03: Not Whitelist Contract");
        (bool success, ) = swapTarget.call{value: _fromToken == _ETH_ADDRESS_ ? msg.value : 0}(callDataConcat);

        require(success, "CrosspolyV1Proxy03: External Swap execution Failed");
    ...
    function mixSwapV1(
        ...
        require(mixPairs.length == directions.length, "CrosspolyV1Proxy03: PARAMS_LENGTH_NOT_MATCH");
        require(mixPairs.length > 0, "CrosspolyV1Proxy03: PAIRS_EMPTY");
        require(minReturnAmount > 0, "CrosspolyV1Proxy03: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_SELL_CHI");
        require(toToken != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_BUY_CHI");
        ...
        for (uint256 i = 0; i < mixPairs.length; i++) {
            ...
            if (directions[i] == 0) {
                ...
                require(portionPath[0] != _CHI_TOKEN_, "CrosspolyV1Proxy03: NOT_SUPPORT_CHI");
