...
module.exports = {
  ...
  deploySwitch: {
    ...
    MOCK_TOKEN:     false,
    MOCK_V2_POOL:   false,
    vCrosspolyToken:     false,
    CrosspolyRecharge:   false,
    MINE:           false,
    FEERATEIMPL:    false,
    WETH:           false,
    Crosspoly:           false,
  ...
  networks: {
    ...
    rinkeby: {
      ...
      provider: function () {
        ...
        // return new HDWalletProvider(privKey, "https://eth-rinkeby.crosspolyex.io");
      },
      gas: 10000000,
      gasPrice: 1500000000,
      network_id: 4,
    ...
    mbtestnet: {
      provider: () => {
        return new HDWalletProvider(privKey, 'https://moonbeam-rpc.crosspolyex.io');
      },
      network_id: 1281,
    },
