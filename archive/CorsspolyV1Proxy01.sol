...
import {ICrosspolyV1Proxy01} from "./intf/ICrosspolyV1Proxy01.sol";
import {InitializableOwnable} from "../lib/InitializableOwnable.sol";


/**
 * @title CrosspolyV1Proxy01
 * @author Crosspoly Breeder
 *
 * @notice Entrance of trading in Crosspoly platform
 */
contract CrosspolyV1Proxy01 is ICrosspolyV1Proxy01, InitializableOwnable {
    ...
    uint8 public _GAS_Crosspoly_MAX_RETURN_ = 0;
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.timestamp, "CrosspolyV1Proxy01: EXPIRED");
        _;
    }
    ...
    function crosspolySwapV1(
        ...
        require(crosspolyPairs.length == directions.length, "CrosspolyV1Proxy01: PARAMS_LENGTH_NOT_MATCH");
        ...
        if (fromToken != _ETH_ADDRESS_) {
            ...
            require(msg.value == fromTokenAmount, "CrosspolyV1Proxy01: ETH_AMOUNT_NOT_MATCH");
            IWETH(_WETH_).deposit{value: fromTokenAmount}();
        }

        for (uint8 i = 0; i < crosspolyPairs.length; i++) {
        ...
        require(returnAmount >= minReturnAmount, "CrosspolyV1Proxy01: Return amount is not enough");
        ...
        uint8 _gasDodoMaxReturn = _GAS_Crosspoly_MAX_RETURN_;
    ...
    function externalSwap(
        ...
        require(isWhiteListed[swapTarget], "CrosspolyV1Proxy01: Not Whitelist Contract");
        (bool success, ) = swapTarget.call{value: _fromToken == _ETH_ADDRESS_ ? msg.value : 0}(callDataConcat);

        require(success, "CrosspolyV1Proxy01: External Swap execution Failed");
    ...
    function mixSwapV1(
        ...
        require(mixPairs.length == directions.length, "CrosspolyV1Proxy01: PARAMS_LENGTH_NOT_MATCH");
