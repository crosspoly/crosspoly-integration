...
/**
 * @title Crosspoly Token Mapped on BSC
 * @author Crosspoly Breeder
 */
contract CrosspolyBscToken is InitializableOwnable {
    using SafeMath for uint256;

    string public name = "Crosspoly bird";
    uint256 public decimals = 18;
    string public symbol = "Crosspoly";
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "CrosspolyBscToken: NOT_ENOUGH");
