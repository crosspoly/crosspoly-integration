...
interface ICrosspolyMineV3Registry {
    function addMineV3(
        address mine,
        bool isLpToken,
        address stakeToken
...
/**
 * @title CrosspolyMineV3 Registry
 * @author Crosspoly Breeder
 *
 * @notice Register CrosspolyMineV3 Pools 
 */
contract CrosspolyMineV3Registry is InitializableOwnable, ICrosspolyMineV3Registry {
