# Crosspoly V2: Help 1 Trillion People Issue Token

## Audit Report

[Audited by Peckshield](https://github.com/CrosspolyEX/contractV2/blob/main/audit/PeckShield-Audit-CrosspolyV2-v1.0.pdf)
...
Any vulnerability or bug discovered must be reported only to the following email: contact@crosspolyex.io; must not be disclosed publicly; must not be disclosed to any other person, entity or email address prior to disclosure to the contact@crosspolyex.io email; and must not be disclosed in any way other than to the contact@crosspolyex.io email. In addition, disclosure to contact@crosspolyex.io must be made promptly following discovery of the vulnerability. Please include as much information about the vulnerability as possible, including:
...
Send E-mail to contact@crosspolyex.io