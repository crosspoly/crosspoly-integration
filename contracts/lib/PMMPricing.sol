 ...
 *
 * @notice Crosspoly Pricing model
 */
...
library PMMPricing {
        ...
        )
    {
        ...
        return
            CrosspolyMath._SolveQuadraticFunctionForTrade(
                state.Q0,
                state.Q0,
                payBaseAmount,
                state.i,
    ...
    {
        return
            CrosspolyMath._GeneralIntegrate(
                state.Q0,
    ...
    function adjustedTarget(PMMState memory state) internal pure {
        if (state.R == RState.BELOW_ONE) {
            state.Q0 = CrosspolyMath._SolveQuadraticFunctionForTarget(
                state.Q,
            ...
            state.B0 = CrosspolyMath._SolveQuadraticFunctionForTarget(
                state.B,
