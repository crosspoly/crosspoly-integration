...
/**
 * @title CrosspolyV1Proxy04
 * @author Crosspoly Breeder
 *
 * @notice Entrance of trading in Crosspoly platform
 */
contract CrosspolyV1Proxy04 is ICrosspolyV1Proxy02, InitializableOwnable {
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.timestamp, "CrosspolyV1Proxy04: EXPIRED");
        _;
    }
    ...
    function crosspolySwapV1(
        ...
        require(crosspolyPairs.length > 0, "CrosspolyV1Proxy04: PAIRS_EMPTY");
        require(minReturnAmount > 0, "CrosspolyV1Proxy04: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_SELL_CHI");
        require(toToken != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_BUY_CHI");
        ...
        if (fromToken != _ETH_ADDRESS_) {
            ...
            require(msg.value == fromTokenAmount, "CrosspolyV1Proxy04: ETH_AMOUNT_NOT_MATCH");
        ...
        for (uint256 i = 0; i < crosspolyPairs.length; i++) {
            ...
            if (directions & 1 == 0) {
                ...
                require(curDodoBase != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_CHI");
                ...
                require(curDodoQuote != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_CHI");
        ...
        require(returnAmount >= minReturnAmount, "CrosspolyV1Proxy04: Return amount is not enough");
    ...
    function externalSwap(
        ...
        require(isWhiteListed[swapTarget], "CrosspolyV1Proxy04: Not Whitelist Contract");
        (bool success, ) = swapTarget.call{value: _fromToken == _ETH_ADDRESS_ ? msg.value : 0}(callDataConcat);

        require(success, "CrosspolyV1Proxy04: External Swap execution Failed");
    ...
    function mixSwapV1(
        ...
        require(mixPairs.length == directions.length, "CrosspolyV1Proxy04: PARAMS_LENGTH_NOT_MATCH");
        require(mixPairs.length > 0, "CrosspolyV1Proxy04: PAIRS_EMPTY");
        require(minReturnAmount > 0, "CrosspolyV1Proxy04: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_SELL_CHI");
        require(toToken != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_BUY_CHI");
        ...
        for (uint256 i = 0; i < mixPairs.length; i++) {
            ...
            if (directions[i] == 0) {
                ...
                require(portionPath[0] != _CHI_TOKEN_, "CrosspolyV1Proxy04: NOT_SUPPORT_CHI");
