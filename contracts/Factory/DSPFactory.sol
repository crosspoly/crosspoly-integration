...
interface IDSPFactory {
    function createCrosspolyStablePool(
        address baseToken,
        address quoteToken,
        uint256 lpFeeRate,
        uint256 i,
...
/**
 * @title Crosspoly StablePool Factory
...
contract DSPFactory is InitializableOwnable {
    ...
    function getCrosspolyPoolByUser(address user) external view returns (address[] memory machines) {
