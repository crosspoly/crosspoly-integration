...
interface ICrosspolyNFTRegistry {
...
/**
 * @title CrosspolyNFT Registry
 * @author Crosspoly Breeder
 *
 * @notice Register CrosspolyNFT Pools 
 */
contract CrosspolyNFTRegistry is InitializableOwnable, ICrosspolyNFTRegistry {
