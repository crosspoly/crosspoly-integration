...
/**
 * @title CrosspolyCpProxy
 * @author Crosspoly Breeder
 *
 * @notice CrowdPooling && UpCrowdPooling Proxy
 */
contract CrosspolyCpProxy is ReentrancyGuard {
    ...
    function createUpCrowdPooling(
        ...
        newUpCrowdPooling = ICrosspolyV2(_UPCP_FACTORY_).createCrowdPooling();
        ...
        require(success, "CrosspolyCpProxy: Transfer failed");

        ICrosspolyV2(_UPCP_FACTORY_).initCrowdPooling(
            newUpCrowdPooling,
            msg.sender,
            _baseToken,
            _quoteToken,
