...
interface IDropsFeeModel {
    function getPayAmount(address crosspolyDrops, address user, uint256 originalPrice, uint256 ticketAmount) external view returns (uint256, uint256);
}
...
contract CrosspolyDrops is InitializableMintableERC20, ReentrancyGuard {
