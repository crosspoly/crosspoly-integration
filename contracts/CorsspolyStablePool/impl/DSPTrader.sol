...
contract DSPTrader is DSPVault {
    ...
    event CrosspolyFlashLoan(address borrower, address assetTo, uint256 baseAmount, uint256 quoteAmount);
    ...
    function flashLoan(
        ...
        if (data.length > 0)
            ICrosspolyCallee(assetTo).DSPFlashLoanCall(msg.sender, baseAmount, quoteAmount, data);
        ...
        emit CrosspolyFlashLoan(msg.sender, assetTo, baseAmount, quoteAmount);
    }
