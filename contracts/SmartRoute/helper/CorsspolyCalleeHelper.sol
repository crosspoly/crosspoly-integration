...
contract CrosspolyCalleeHelper is ReentrancyGuard {
    ...
    function DVMSellShareCall(
        ...
        address _baseToken = ICrosspolyV2(msg.sender)._BASE_TOKEN_();
        address _quoteToken = ICrosspolyV2(msg.sender)._QUOTE_TOKEN_();
