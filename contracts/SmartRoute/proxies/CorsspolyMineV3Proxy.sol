...
import {IRewardVault} from "../../CrosspolyToken/CrosspolyMineV3/RewardVault.sol";
import {ICrosspolyMineV3Registry} from "../../Factory/Registries/CrosspolyMineV3Registry.sol";
...
/**
 * @title CrosspolyMineV3 Proxy
 * @author Crosspoly Breeder
 *
 * @notice Create And Register CrosspolyMineV3 Contracts 
 */
contract CrosspolyMineV3Proxy is InitializableOwnable {
    using SafeMath for uint256;
    // ============ Templates ============

    address public immutable _CLONE_FACTORY_;
    address public immutable _Crosspoly_APPROVE_PROXY_;
    address public immutable _Crosspoly_MINEV3_REGISTRY_;
    ...
    constructor(
        ...
        address crosspolyMineV3Registry
    ) public {
        _CLONE_FACTORY_ = cloneFactory;
        _MINEV3_TEMPLATE_ = mineTemplate;
        _Crosspoly_APPROVE_PROXY_ = crosspolyApproveProxy;
        _Crosspoly_MINEV3_REGISTRY_ = crosspolyMineV3Registry;
    }

    // ============ Functions ============

    function createCrosspolyMineV3(
        address stakeToken,
        bool isLpToken,
        ...
        for(uint i = 0; i<rewardTokens.length; i++) {
            ...
            ICrosspolyApproveProxy(_Crosspoly_APPROVE_PROXY_).claimTokens(rewardTokens[i], msg.sender, newMineV3, rewardAmount);
        ...
        ICrosspolyMineV3Registry(_Crosspoly_MINEV3_REGISTRY_).addMineV3(newMineV3, isLpToken, stakeToken);
    ...
    function depositRewardToVault(
        ...
        ICrosspolyApproveProxy(_Crosspoly_APPROVE_PROXY_).claimTokens(rewardToken, msg.sender, rewardVault, amount);
    ...
    function depositRewardToMine(
        ...
        ICrosspolyApproveProxy(_Crosspoly_APPROVE_PROXY_).claimTokens(rewardToken, msg.sender, mineV3, amount);
