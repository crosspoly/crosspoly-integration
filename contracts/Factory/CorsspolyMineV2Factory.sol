...
/**
 * @title CrosspolyMineV2 Factory
 * @author Crosspoly Breeder
 *
 * @notice Create And Register CrosspolyMineV2 Contracts 
 */
contract CrosspolyMineV2Factory is InitializableOwnable {
    // ============ Templates ============
    ...
    function createCrosspolyMineV2(
        address stakeToken,
